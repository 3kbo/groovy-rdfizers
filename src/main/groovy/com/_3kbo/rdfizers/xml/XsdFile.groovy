...
class XsdFile extends XmlFile {
	...
	/**
	 * Export the RDF description of the Xml Schema file in N3 format to the output file.
	 * The export includes the RDF descriptions of all the imported and included Xml Schemas.
	 * @param output
	 * @return
	 */
